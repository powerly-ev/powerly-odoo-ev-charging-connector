{'application': False,
 ...
 'summary': 'Connect Odoo with Powerly to synchronize EV chargers and charging orders from OCPP-compatible infrastructure for operations and accounting workflows.',
 'version': '18.0.1.0.0',
